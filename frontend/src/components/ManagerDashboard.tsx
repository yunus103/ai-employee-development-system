    ...
    return (
      <div className="space-y-8 animate-pulse">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          <div className="lg:col-span-3 glass-panel rounded-2xl p-6 border border-card-border space-y-4 h-96">
          ...
          <div className="lg:col-span-2 glass-panel rounded-2xl p-6 border border-card-border space-y-4 h-96">
            <div className="h-6 bg-card-border/30 rounded w-1/3 mb-6"></div>
            <div className="space-y-4">
              {[1, 2].map((i) => (
                <div key={i} className="h-24 bg-card-border/30 rounded-xl"></div>
              ))}
            </div>
          </div>
        </div>
